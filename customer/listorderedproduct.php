				...
				WHERE   s.`CUSTOMERID`=c.`CUSTOMERID` and ORDEREDNUM=" . $_SESSION['ordernumber'];
				 ...
				 foreach ($res as $row)
					 echo $row->countitem; ?></p> 
							...
							<h5>DEAR Ma'am/Sir ,</h5>
							<h5>Your order is on its way! As you have ordered via Cash on Delivery, please have the exact amount
								of cash for our deliverer. </h5>
							<hr />
				...
				WHERE   s.`CUSTOMERID`=c.`CUSTOMERID` and ORDEREDNUM=" . $_SESSION['ordernumber'];
					...
					<div class="row">
						<div class="col-md-6 pull-left">
							<div>Ordered Date :
								<?php echo date_format(date_create($cur->ORDEREDDATE), "M/d/Y h:i:s"); ?>
							</div>
			...
			<div class="modal-footer">
				<div id="divButtons" name="divButtons">
					<?php if ($cur->ORDEREDSTATS != 'Pending' || $cur->ORDEREDSTATS != 'Cancelled') { ?>
						...
						<button onclick="tablePrint();" class="btn btn_fixnmix pull-right "><span
