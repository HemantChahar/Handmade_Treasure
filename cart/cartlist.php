    ...
    <div class="col-md-12 col-sm-8 content">
      <div class="row">
        <div class="col-md-12">
                ...
                <table class="table table-default " id="table">
                  <thead>
                    <tr>
                      <td>
                        <div class="culomn4">
                          <div style="float: left; width:90px">Product</div>
                        </div>
                        <div class="culomn4">
                        ...
                        <div class="culomn4">
                          <div style="float: left; width:110px">Price</div>
                        </div>
                        <div class="culomn4">
                          <div style="float: left; width:50px">Total</div>
                        </div>
                      </td>
                    </tr>
                  </thead>
                          ...
                          if (!empty($_SESSION['fixnmix_cart'])) {
                            ...
                            for ($i = 0; $i < $count_cart; $i++) {
                              ...
                              foreach ($cur as $result) {
                                ...
                                <form id="form" action="cart/controller.php?action=edit" method="POST" onmousemove=" if(QTY.value=='' || QTY.value<1){
                                          QTY.value =1;
                                          }else{
                                  ...
                                  <div class="column4">
                                    ...
                                    <div class="form-inline" style="float: left; width:190px">
                                      <input class="form-control" autocomplete="off" id="QTY"
                                        name="QTY<?php echo $result->PRODUCTID ?>" type="number"
                                      ...
                                      <!-- END -->
                                      <a href="cart/controller.php?action=delete&id=<?php echo $result->PRODUCTID; ?>"
                                        class="btn btn-link">Remove</a>
                                      <button type="submit" name="update" class="btn btn-link">Update</button>
                                    </div>

                                    <!-- <div style="float: right; width:100px"></div> -->
                                    <div style="float: left; width:50px">&nbsp;&nbsp;&#8377 <span
                                        id="price1"><?php echo $result->PRICE; ?></span></div>
                      ...
                      <td>
                        <div class="culomn4">
                          <div style="float: right;">
                            <h1> Total Price : &#8377 <span id="sum">0</span></h1>
                          </div>
                        </div>
                      </td>
          ...
          <a href="index.php?page=2" class="btn btn-default pull-left"><span
              class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Add New Order</strong></a>
          <a href="index.php?page=7" name="proceed" class="btn btn_fixnmix pull-right"><strong>Proceed And
              Checkout</strong> <span class="glyphicon glyphicon-chevron-right"></span></a>
