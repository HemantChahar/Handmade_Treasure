        ...
        <div class="">
          <div class="panel panel-default">
            <div class="panel-body">
              <fieldset>
                <legend>
                  <h2 class="text-left">Cart List</h2>
                </legend>
                <div>Every products has a mininum price of &#8377 50.00 each to be able to order.</div>
                <div class="table-responsive">
                    ...
                    <table class="table fixnmix-table" id="table">
                      ...
                      WHERE  p.`CATEGORYID`=c.`CATEGORYID` and PRODUCTID='" . $_SESSION['fixnmix_cart'][$i]['productid'] . "'";
                            ...
                            foreach ($cur as $result) {
                              ...
                              <tr>
                                <td></td>
                                <td><img src="<?php echo web_root . 'admin/modules/product/' . $result->IMAGES; ?>"
                                    width="50px" height="50px"></td>
                                <td><?php echo $result->PRODUCTNAME ?></td>
                                <td>&#8377 <?php echo number_format($result->PRICE, 2) ?></td>
                                <td><input type="NUMBER" data-id="<?php echo $result->PRODUCTID; ?>" class="cusqty"
                                    name="QTY<?php echo $result->PRODUCTID; ?>" id="QTY<?php echo $result->PRODUCTID; ?>"
                                    value="<?php echo $_SESSION['fixnmix_cart'][$i]['qty'] ?>" />
                                <td>&#8377 <output
                                    id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo $_SESSION['fixnmix_cart'][$i]['price']; ?></output>

                                  <!-- hidden textbox -->
                                  <input type="hidden" name="TOT<?php echo $result->PRODUCTID; ?>"
                                    id="TOT<?php echo $result->PRODUCTID; ?>"
                                    value="<?php echo $_SESSION['fixnmix_cart'][$i]['price'] ?>" />
                                </td>
                                <input type="hidden" name="PRICE<?php echo $result->PRODUCTID; ?>"
                                  id="PRICE<?php echo $result->PRODUCTID; ?>"
                                  value="<?php echo $_SESSION['fixnmix_cart'][$i]['price'] ?>" /></td>
                                <input type="hidden" name="originalPRICE<?php echo $result->PRODUCTID; ?>"
                                  id="originalPRICE<?php echo $result->PRODUCTID; ?>" value="<?php echo $result->PRICE ?>" />
                                </td>
                                <input type="hidden" name="originalqty<?php echo $result->PRODUCTID; ?>"
                                  id="originalqty<?php echo $result->PRODUCTID; ?>" value="<?php echo $result->QTY ?>" />
                                </td>

                                <!-- end -->
                                <td> <a href="cart/controller.php?action=delete&id=<?php echo $result->PRODUCTID; ?>"
                                    data-id="<?php echo $result->PRODUCTID ?>" class="delete btn btn-danger btn-xs">Remove</a>
                                </td>
                              </tr>
                              <?php
                            }
                  ...
                  <table>
                    <tfoot>
                      <strong>
                        <h1 align="right">Total Price : &#8377 <span style="margin-right:3%" id="sum">0.00</span></h1>
                      </strong></td>
          ...
          <div class="tab-content">
                ...
                <div class="modal-body">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input name="user_pass2" id="user_pass2" placeholder="Password" type="password"
                        class="form-control">
                    </div>
                  </div>
            ...
            <div class="tab-pane" id="settings"><br /><br />
              <form class="form-horizontal span6" action="customer/controller.php?action=add"
                onsubmit="return  validatecustomer()" name="personal" method="POST" enctype="multipart/form-data">
                <?php
                ...
                <div class="form-group">
                  <div class="col-md-10">
                    ...
                    <div class="col-md-8">
                      <input class="form-control input-sm" id="FIRSTNAME" name="FIRSTNAME" placeholder="First Name"
                        type="text" value="">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-10">
                    ...
                    <div class="col-md-8">
                      <input class="form-control input-sm" id="LASTNAME" name="LASTNAME" placeholder="Last Name"
                        type="text" value="">
                    </div>
                  </div>
                </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-head" style="margin-left:3%">
                    <h3>address</h3>
                  </div>
                  <div class="panel-body">
                    <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input class="form-control input-sm" id="HOMENUMBER" name="HOMENUMBER"
                            placeholder="Home Number" type="text" value="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-10">
                        <label class="col-md-4 control-label" for="STREET">Street / Village :</label>

                        <div class="col-md-8">
                          <input class="form-control input-sm" id="STREET" name="STREET" placeholder="Street"
                            type="text" value="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <label class="col-md-4 control-label" for="BARANGGY">Barangay:</label>

                        <div class="col-md-8">
                          <input class="form-control input-sm" id="BARANGGY" name="BARANGGY" placeholder="Barangay"
                            type="text" value="">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-md-10">
                        <label class="col-md-4 control-label" for="CITYADDRESS">City:</label>

                        <div class="col-md-8">
                          <input class="form-control input-sm" id="CITYADDRESS" name="CITYADDRESS"
                            placeholder="City Address" type="text" value="">
                        </div>
                      </div>
                    </div>
                ...
                <div class="form-group">
                  <div class="col-md-10">
                    ...
                    <div class="col-md-8">
                      <input class="form-control input-sm" id="USERNAME" name="USERNAME" placeholder="username"
                        type="text" value="">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-10">
                    ...
                    <div class="col-md-8">
                      <input class="form-control input-sm" id="CONTACTNUMBER" name="CONTACTNUMBER"
                ...
                <div class="form-group">
                  <div class="col-md-10">
                    ...
                    <div class="col-md-8">
                      <input class="form-control input-sm" id="ZIPCODE" name="ZIPCODE" placeholder="Zip Code"
                        type="number" value="">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-10">
                    ...
                    <div class="col-md-8">
                      <p>
                        ...
                        <small>Agree the <a class="toggle-modal"
                            onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"><b>TERMS AND
                              CONDITION</b></a> of this Bakeshop</small>
