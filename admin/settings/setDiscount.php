        ...
        <div class="row">
          <div class="col-m-12">
            <div class="col-md-8 responsive">
              <img width="250" class="img-portfolio " height="200"
                src="<?php echo web_root . 'admin/products/' . $result->IMAGES; ?>" alt="">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="hidden" class="form-control " name="PROPRICE" id="PROPRICE"
                value=" <?php echo $result->PROPRICE; ?>">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="PRODISPRICE" id="PRODISPRICE" placeHolder="0.0"
                readonly="true">
            </div>
            <!-- /.input group -->
          </div>
