...
<form class="form-horizontal span6" action="controller.php?action=add" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input class="form-control input-sm" id="OWNERNAME" name="OWNERNAME" placeholder="Owner Name" type="text"
          value="">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input class="form-control input-sm" id="OWNERPHONE" name="OWNERPHONE" placeholder="+63 0000000000"
          type="number" value="">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-3">
        <input class="form-control input-sm" id="ORIGINALPRICE" name="ORIGINALPRICE" placeholder="Original Price"
          type="number" value="" step="any">
      </div>
      <label class="col-md-2 control-label" for="PROPRICE">Price:</label>

      <div class="col-md-3">
        <input class="form-control input-sm" id="PROPRICE" step="any" name="PROPRICE" placeholder="&#8377 Price "
          type="number" value="">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input class="form-control input-sm" id="PROQTY" name="PROQTY" placeholder="Quantity" type="number" value="">
      </div>
