    ...
    <div class="row">
      <div class="col-md-4">
        <a data-target="#myModal" data-toggle="modal" href="" title="Click here to Change Image.">
          <img alt="" style="width:600px; height:400px;>" title="" class="img-circle img-thumbnail isTooltip"
            src="<?php echo $singleproduct->IMAGES; ?>" data-original-title="Usuario">
          ...
          <table class="table table-condensed table-responsive table-user-information">
            <tbody>
              ...
              <tr>
                ...
                <td class="text-primary">
                  <?php echo ': &#8377 ' . $singleproduct->PROPRICE; ?>
                </td>
              </tr>
...
<div class="modal fade" id="myModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="controller.php?action=photos&id=<?php echo $PROID; ?>" enctype="multipart/form-data" method="post">
