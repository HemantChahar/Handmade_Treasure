    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo web_root; ?>admin/index.php">Handmade Treasure E-Commerce</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Hello, <?php echo $_SESSION['U_NAME']; ?> <img title="profile image" width="23px" height="17px"
...
<footer>
    <p style="text-align: center;font-weight: bold;">Copyright &copy; Handmade Treasure Project Guidence By:
        Technosters, Agra </p>
</footer>
