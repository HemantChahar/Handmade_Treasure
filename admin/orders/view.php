            ...
            <div class="row">
                <div class="col-md-4">
                    <a data-target="#myModal" data-toggle="modal" href="" title="Click here to Change Image.">
                        <img alt="" style="width:600px; height:400px;>" title="" class="img-square img-thumbnail isTooltip"
                            src="<?php echo web_root . 'customer/' . $singlecustomer->IMAGE; ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <a data-target="#myModal" data-toggle="modal" href=""
                                            ...
                                            <img alt="" style="width:600px; height:400px;>" title=""
                                                class="img-circle img-thumbnail isTooltip"
                                                src="../product/<?php echo $singleproduct->IMAGE; ?>"
                                                data-original-title="Usuario">
                                            ...
                                            <table class="table table-condensed table-responsive table-user-information">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="index.php" class="btn btn_fixnmix" name="back"
                                                            type="submit">Back</a>
                                                    </td>
                                                    <td>
