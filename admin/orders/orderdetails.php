...
<div class="container">
  ...
  <div class="">
    <div class="panel panel-default">
          ...
          <table class="fixnmix-table">
            ...
            <tbody>
              <tr>
                ...
                <td width="350px">
                  <input id="FIRSTNAME" name="FIRSTNAME" class="form-control input-sm" type="text"
                    value="<?php echo isset($_SESSION['FIRSTNAME']) ? $_SESSION['FIRSTNAME'] : ""; ?>">
                </td>
                <td width="100px">Last Name</td>
                <td> <input id="LASTNAME" name="LASTNAME" class="form-control input-sm" type="text"
                    value="<?php echo isset($_SESSION['LASTNAME']) ? $_SESSION['LASTNAME'] : ""; ?>"></td>
              </tr>
              <tr>
                <td>Address </td>
                <td> <input id="ADDRESS" name="ADDRESS" class="form-control input-sm" type="text"
                    value="<?php echo isset($_SESSION['ADDRESS']) ? $_SESSION['ADDRESS'] : ""; ?>"></td>
                <td width="100px">Contact Number </td>
                <td width="350px"> <input id="CONTACTNUMBER" name="CONTACTNUMBER" class="form-control input-sm"
                    type="number"
                    value="<?php echo isset($_SESSION['CONTACTNUMBER']) ? $_SESSION['CONTACTNUMBER'] : ""; ?>"></td>
              </tr>
            </tbody>
            <tfoot>
              <tr>
      ...
      <div class="container">
        <div class="row">
          <h3 align="right" margin-right="20%">Total Price : &#8377 <span id="sum">0.00</span></h3>
        </div>
      </div>
      ...
      <a href="index.php?view=addtocart" class="btn btn-default"><span
          class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>View Cart</strong></a>
      <button name="submitorder" id="submitorder" class="btn btn_fixnmix pull-right"
        onclick="validatedate()"><strong>Save Order</strong> <span
