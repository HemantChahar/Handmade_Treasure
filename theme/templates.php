...
<head>
  ...
  <title>Home | Handmade Treasure</title>
...
<body style="background-color:white" onload="totalprice()">
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +91 7302496060</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> hemantchahar151@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="social-icons pull-right">
              <ul class="nav navbar-nav">
                <li><a href="www.linkedin.com/in/hemant-chahar-794604283"><i class="fa fa-facebook"></i></a></li>
                <li><a href="https://www.instagram.com/_hemant_jaat_?igsh=MWl0ZWxmYzQ2OWNqdA=="><i
                      class="fa fa-instagram"></i></a></li>
                <li><a href="linkedin.com/in/hemant-chahar-794604283"><i class="fa fa-linkedin"></i></a></li>
          ...
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root ?>">
                <img src="imagesHT/Logo/LOGO2.JPG" />
              </a>
            </div>
          </div>
  ...
  <footer id="footer"><!--Footer-->
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Handmade</span> Treasure</h2>
          ...
          <div class="col-sm-7">
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#">
                  <iframe class="iframe-img" src="https://www.youtube.com/embed/d8N21Q_UN4w"
            ...
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#">
                  <iframe class="iframe-img" src="https://www.youtube.com/embed/aMDC3Da4KIA" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
                </a>
              </div>
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>Madhunagar, Agra (282001), U.P, India</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a
                href="https://www.instagram.com/_hemant_jaat_?igsh=MWl0ZWxmYzQ2OWNqdA==">Hemant Chahar</a></span></p>
          <p class="pull-right">With <span><a target="_blank" href="#">Mona</a></span>
          </p>
        </div>
      </div>
    </div>
