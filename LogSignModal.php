          ...
          <div class="tab-content">
            <div class="tab-pane fade in active" id="home">
              ...
              <div class="panel panel-pup">
                  ...
                  <form class="form-horizontal span6" name="" action="login.php" method="POST">
                    ...
                    <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <button type="submit" id="modalLogin" name="modalLogin" class="btn btn-pup"><span
                ...
                <div class="panel-footer">
                  <!-- <p align="left">&copy; <a href="#">Hemant Chahar</a></p> -->
            ...
            <div class="tab-pane fade" id="profile">
              ...
              <form class="form-horizontal span6" action="customer/controller.php?action=add"
                onsubmit="return personalInfo();" name="personal" method="POST" enctype="multipart/form-data">
                <div class="panel panel-pup">
                  <div class="panel-heading">
                    Customer Details
                  </div>
                  <div class="panel-body">
                      ...
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input id="GENDER" name="GENDER" placeholder="Gender" type="radio" checked="true"
                            value="Male"><b> Male </b>
                          <input id="GENDER" name="GENDER" placeholder="Gender" type="radio" value="Female"> <b> Female
                          </b>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-10">
                        <label class="col-md-4 control-label" for="CITYADD">Municipality/City:</label>

                        <div class="col-md-8">
                          <input class="form-control input-sm" id="CITYADD" name="CITYADD"
                            placeholder="Municipality/City Address" type="text" value="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input class="form-control input-sm" id="CUSPASS" name="CUSPASS" placeholder="Password"
                    ...
                    <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder="+63 0000000000"
                            type="number" value="">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <p> I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                            <small>Agree with the <a class="toggle-modal"
                                onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"><b>TERMS AND
                                  CONDITION</b></a> of Janobe Source Code.</small>
