<section id="cart_items">
  <div class="container">
    ...
    <div class="table-responsive cart_info">
          ...
          for ($i = 0; $i < $count_cart; $i++) {
            ...
            foreach ($cur as $result) {
             ...
             ';
                ...
                <td>
                  <input type="hidden" id="PROPRICE<?php echo $result->PROID; ?>" name="PROPRICE<?php echo $result->PROID; ?>"
                    value="<?php echo $result->PRODISPRICE; ?>">

                  &#8377 <?php echo $result->PRODISPRICE; ?>
                </td>
                <td class="input-group custom-search-form">
                  ...
                  <input type="number" maxlength="3" data-id="<?php echo $result->PROID; ?>" class="QTY form-control input-sm"
                    autocomplete="off" id="QTY<?php echo $result->PROID; ?>" name="QTY<?php echo $result->PROID; ?>"
                    value="<?php echo $_SESSION['gcCart'][$i]['qty']; ?>" placeholder="Search for...">
                ...
                <td> &#8377 <output
                    id="Osubtot<?php echo $result->PROID ?>"><?php echo $_SESSION['gcCart'][$i]['price']; ?></output></td>
              </tr>
      ...
      <h3 align="right"> Total &#8377 <span id="sum">0</span></h3>
    </div>
  </div>
